...
SpectrumChartD3 = function(elem, options) {
  ...
  this.options.showPeakLabels = (typeof options.showPeakLabels == 'boolean') ? options.showPeakLabels : true;
  this.options.showNuclideNames = (typeof options.showNuclideNames == 'boolean') ? options.showNuclideNames : true;
...
SpectrumChartD3.prototype.getYAxisDomain = function(){
  ...
  if( self.options.yscale == "log" ) {
    ...
    var yupper = Math.pow( 10.0, logUpperY )*20;
